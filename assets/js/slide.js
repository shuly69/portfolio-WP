...
let sliderElemWidth = document.querySelector('.portfolio-slider')
let sliderWidth = 0
let offsetMax = sliderElemWidth.clientWidth
...
function resizeWindow(event) {
    let elemWidth = sliderElemWidth.clientWidth

    offsetMax = elemWidth
    if(elemWidth > 1000) {
        sliderWidth = elemWidth / 3
...
function navMenu(event) {
    ...
    if(element.classList.contains('menu-slider__item')) {
        ...
        switch(element.outerText) {
            ...
            offsetMax = sliderElemWidth.clientWidth
